            ...
            <div className="head-left-home-student">
              <h1 className="intro-head-student">
                ...
                <span className="student-name">
                  {dataBerandaMurid.nama || <Skeleton width={40} />}
                </span>
              </h1>
                ...
                <div className="indiecator-left">
                  ...
                  <div className="desc-indie">
                    <p className="title-indie-information">
                      {" "}
                      <span>{dataBerandaMurid.belum_dalamdeadline}</span> Tugas
                    </p>
              ...
              >
                <div className="indiecator-left">
                  ...
                  <div className="desc-indie">
                    <p className="title-indie-information">
                      {" "}
                      <span>{dataBerandaMurid.selesai_dalamdeadline}</span>{" "}
                      Tugas
                    </p>
                    <p className="value-indie-information">
                      Dari <span>{dataBerandaMurid.jumlah_tugas}</span> Tugas
              ...
              >
                <div className="indiecator-left">
                  ...
                  <div className="desc-indie">
                    <p className="title-indie-information">
                      {" "}
                      <span>{dataBerandaMurid.belum_lebihdeadline}</span> Tugas
                    </p>
                    <p className="value-indie-information">
                      Dari <span>{dataBerandaMurid.jumlah_tugas}</span> Tugas
                    </p>
              ...
              >
                <div className="indiecator-left">
                  ...
                  <div className="desc-indie">
                    <p className="title-indie-information">
                      {" "}
                      <span>{dataBerandaMurid.selesai_lebihdeadline}</span>{" "}
                      Tugas
                    </p>
                    <p className="value-indie-information">
                      Dari <span>{dataBerandaMurid.jumlah_tugas}</span> Tugas
